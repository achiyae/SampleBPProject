...
public class Main {
  ...
  private SampleDomain example = null;
  ...
  public static void main(String[] args) throws Exception {
    ...
    main.loadSampleDomain(SampleDomain.HotCold);
    ...
    var map = main.mapSpace();

    // write the graph to files:
    main.writeGraphs(map);
  ...
  private void loadSampleDomain(SampleDomain domain) {
    example = domain;
  ...
  private void loadResources(String[] resources) {
    ...
    this.bprog = new ContextBProgram(resources); // you can add more files
    this.name = bprog.getName();
...
//    vfr.setDebugMode(true);
  ...
  private MapperResult mapSpace() throws Exception {
    if (example != null) {
      example.addVerificationResources(bprog);
    }
